...
class Satellites_road(data.Dataset):
    ...
    **Parameters:**
    ...
    classes = [
        ...
        SatellitesClass('road',                 7, 1, 'flat', 1, True, False, (100, 200, 28)),
        ...
        SatellitesClass('building',             11, 255, 'construction', 1, False, True, (70, 70, 70)),
